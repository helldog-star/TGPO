...
export MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liuxinyu67/models/Qwen2.5-Math-1.5B
export DATA_DIR=$ROOT/data/
export EXP_NAME=on_policy_qwen2d5_math_1d5b_a3b35k
