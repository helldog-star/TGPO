...
export EXP_NAME=tipo_reg_qwen2d5_math_7b_coef2e-3_decay9e-6_min2e-4
...
python3 -m verl.mix_src.main_mix_ppo \
    ...
    actor_rollout_ref.teacher_ref.min_teacher_coef=0.0002 \
    actor_rollout_ref.teacher_ref.teacher_coef=0.002 \
    actor_rollout_ref.teacher_ref.decay_rate=0.000009 \
    ...
    trainer.total_training_steps=300 "${@:1}"
