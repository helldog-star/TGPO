...
def main_task(config):
    ...
    #NOTE:lxy: if teacher enable we add teacher here
    if config.actor_rollout_ref.teacher_ref.enable:
        role_worker_mapping[Role.TeacherRefPolicy] = ray.remote(MIXActorRolloutRefWorker)
        mapping[Role.TeacherRefPolicy] = "global_pool"
