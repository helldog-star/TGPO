...
from transformers import LlamaConfig, MistralConfig, GemmaConfig, Qwen2Config, Qwen3MoeConfig, Qwen3Config

_REOVEPAD_MODELS = {'llama': LlamaConfig, 'mistral': MistralConfig, 'gemma': GemmaConfig, 'qwen2': Qwen2Config, 'qwen3_moe': Qwen3MoeConfig, 'qwen3': Qwen3Config}
